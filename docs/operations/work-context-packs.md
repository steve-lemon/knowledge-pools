...
- [Specification Review Checklist](spec-review-checklist.md)
...
Use when defining module boundaries, interfaces, functions, classes, objects, data contracts, or validation methods:
