...
| `llm.summarize` / `llm.complete` | `SummaryAgent` prototype first, optional after deterministic flow | optional visual captioning later | optional transcript cleanup later | optional scene summary later | optional PDF summary later |
