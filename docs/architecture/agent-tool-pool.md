...
| `curation` | artifact read/write, schema validate, curation decide, memory write, optional memory status update, optional taxonomy validate, optional rollback/delete events, audit trace |
