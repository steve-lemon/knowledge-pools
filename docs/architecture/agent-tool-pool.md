...
| `connect` | artifact read/write, record search, graph query, taxonomy read/validate, schema validate, candidate emit, ambiguity emit, review request, optional model adapter |
