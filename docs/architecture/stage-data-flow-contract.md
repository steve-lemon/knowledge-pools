...
| `plan -> retrieve` | retrieval plan ref, evidence requirements, freshness scope, conflict-search flag | `PlanToRetrieveHandoff` | plan schema, permitted retrieval paths, freshness constraints |
